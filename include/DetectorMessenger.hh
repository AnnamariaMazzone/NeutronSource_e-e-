...
class DetectorMessenger: public G4UImessenger
{
  ...
  private:
    ...
    G4UIcmdWithAString*        fMaterCmd0;
    G4UIcmdWithAString*        fMaterCmd1;
    G4UIcmdWithAString*        fMaterCmd2;
    G4UIcmdWithAString*        fMaterCmd3;
    G4UIcmdWithADoubleAndUnit* fSizeCmd1;
    G4UIcmdWithADoubleAndUnit* fSizeCmd2;
    G4UIcmdWithADoubleAndUnit* fSizeCmd3;
    G4UIcmdWithADoubleAndUnit* fSizeCmd4;
    G4UIcmdWithADoubleAndUnit* fSizeCmd5;
    G4UIcmdWithADoubleAndUnit* fSizeCmd6;
