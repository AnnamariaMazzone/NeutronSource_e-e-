...
#include <iostream>
#include <fstream>
G4int dim=5000000;//100000;//5000000;
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
...
: G4VUserPrimaryGeneratorAction(), fParticleGun(0), fDetector(det)
{
    ...
    std::string line;
    std::ifstream myfile
    ("/Users/annamaria/lavoro/X17/NeutronSource_e+e-/e_0.347_V_17.0_0.00256_5m.txt");//e_0.347_EM.txt");//e_0.347_V_17.0_0.00256.txt");//_5m.txt
...
//           else continue;
    ...
    void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
    {
        ...
        //
        G4double zmax=fDetector->GetContainerLength()+2*fDetector->GetContainerRadius()-2*fDetector->GetContainTappoThickness()-0.04*mm;//dimensione absorber=A
