...
//    G4double temperature = 30*kelvin;
//
...
//   G4Sphere* sContain=new  G4Sphere("Container",rmin,rmax,0,360*degree,0,360*degree );
//
...
//    // strato PET
//    //
//    G4double spessoreLayer=0.02*mm;
//    rmax=fContainerRadius-fContainThickness;
//    G4Sphere* sLayer=new  G4Sphere("Layer",0,rmax,0,360*degree,0,360*degree );
//       fLLayer = new G4LogicalVolume(sLayer,            //shape
...
//  // Absorber
//  //
//    G4Sphere* sAbsor=new  G4Sphere("Absorber",0,AbsorRadiusTappo,0,pi,0,pi );
//
//
