...
:G4UImessenger(), 
fDetector(Det), fTesthadrDir(0), fDetDir(0), fMaterCmd0(0),fMaterCmd1(0),fMaterCmd2(0),fMaterCmd3(0),
fSizeCmd1(0), fSizeCmd2(0), fSizeCmd3(0),fSizeCmd4(0),fSizeCmd5(0),fSizeCmd6(0),
fIsotopeCmd(0)
{ 
    ...
    fMaterCmd0 = new G4UIcmdWithAString("/testhadr/det/setDetMat",this);
    fMaterCmd0->SetGuidance("Select det material");
    fMaterCmd0->SetParameterName("choice",false);
    fMaterCmd0->AvailableForStates(G4State_PreInit,G4State_Idle);
    ...
    fMaterCmd3 = new G4UIcmdWithAString("/testhadr/det/setLayerMat",this);
    fMaterCmd3->SetGuidance("Select layer material");
    fMaterCmd3->SetParameterName("choice",false);
    fMaterCmd3->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fSizeCmd1 = new G4UIcmdWithADoubleAndUnit("/testhadr/det/setContRadius",this);
    fSizeCmd1->SetGuidance("Set Container radius");
    ...
    fSizeCmd2 = new G4UIcmdWithADoubleAndUnit("/testhadr/det/setContLength",this);
    fSizeCmd2->SetGuidance("Set Container length");
    ...
    fSizeCmd4 = new G4UIcmdWithADoubleAndUnit("/testhadr/det/setContTappoThick",this);
    fSizeCmd4->SetGuidance("Set container tappo thickness");
    fSizeCmd4->SetParameterName("ThickTappo",false);
    fSizeCmd4->SetRange("ThickTappo>0.");
    fSizeCmd4->SetUnitCategory("Length");
    fSizeCmd4->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fSizeCmd5 = new G4UIcmdWithADoubleAndUnit("/testhadr/det/setDetThick",this);
    fSizeCmd5->SetGuidance("Set detector thickness");
    fSizeCmd5->SetParameterName("ThickDet",false);
    fSizeCmd5->SetRange("ThickDet>0.");
    fSizeCmd5->SetUnitCategory("Length");
    fSizeCmd5->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fSizeCmd6 = new G4UIcmdWithADoubleAndUnit("/testhadr/det/setLayerThick",this);
    fSizeCmd6->SetGuidance("Set layer thickness");
    fSizeCmd6->SetParameterName("ThickLayer",false);
    fSizeCmd6->SetRange("ThickLayer>0.");
    fSizeCmd6->SetUnitCategory("Length");
    fSizeCmd6->AvailableForStates(G4State_PreInit,G4State_Idle);
...
{ 
    ...
    if( command == fMaterCmd0 )
    { fDetector->SetDetMaterial(newValue);}
    if( command == fMaterCmd2 )
    { fDetector->SetContainMaterial(newValue);}
    if( command == fMaterCmd3)
    { fDetector->SetLayerMaterial(newValue);}
    if( command == fSizeCmd1 )
    { fDetector->SetContainerRadius(fSizeCmd1->GetNewDoubleValue(newValue));}
    
    if( command == fSizeCmd2 )
    { fDetector->SetContainerLength(fSizeCmd2->GetNewDoubleValue(newValue));}
    
    if( command == fSizeCmd3 )
    { fDetector->SetContainThickness(fSizeCmd3->GetNewDoubleValue(newValue));}
    if( command == fSizeCmd4 )
    { fDetector->SetContainTappoThickness(fSizeCmd4->GetNewDoubleValue(newValue));}
    if( command == fSizeCmd5 ){ fDetector->SetDetThickness(fSizeCmd5->GetNewDoubleValue(newValue));}
    if( command == fSizeCmd6 )
    {fDetector->SetLayerThickness(fSizeCmd6->GetNewDoubleValue(newValue));}
